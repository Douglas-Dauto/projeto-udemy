...
courses.push(new Course('assets/img/courses/Curso-Design-Gráfico-COMPLETO-10-Cursos-do-Zero-ao-Avançado.jpg', 'Curso Design Gráfico COMPLETO 10 Cursos do Zero ao Avançado', 'André Fontenelle', '3,6', '39.154', '169,90', 'Mais vendidos'));
...
courses.push(new Course('assets/img/courses/Modelagem-de-Dados-UML-(Análise&Projeto Orientado a Objetos).jpg', 'Modelagem de Dados UML (Análise&Projeto Orientado a Objetos)', 'Nelio Alves', '2,8', '2.845', '169,90', 'Classificação mais alta'));
courses.push(new Course('assets/img/courses/Criação-de-Apps-Android-iOS-Web-com-Flutter.jpg', 'Criação de Apps Android/iOS/Web com Flutter', 'Daniel Ciolfi, Ewerton Dutra', '3,6', '15.808', '189,90'));
courses.push(new Course('assets/img/courses/Power-BI-Completo-Do-Básico-ao-Avançado.jpg', 'Power BI Completo - Do Básico ao Avançado', 'João Paulo de Lira', '3,7', '64.650', '199,90', 'Mais vendidos'));
...
courses.push(new Course('assets/img/courses/Bootstrap-5-Curso-Completo-e-Direto-ao-Ponto.jpg', 'Bootstrap 5: Curso Completo e Direto ao Ponto', 'Diego Mariano', '2,0', '1.179', '179,90'));
...
courses.push(new Course('assets/img/courses/JavaScript-do-básico-ao-avançado-c-Node.js e projetos.jpg', 'JavaScript do básico ao avançado (c/ Node.js e projetos)', 'Matheus Battisti', '3,7', '3.639', '189,90', 'Classificação mais alta'));
...
courses.push(new Course('assets/img/courses/Curso-Web-Moderno-Completo-com-JavaScript-2022+Projetos.jpg', 'Curso Web Moderno Completo com JavaScript 2022 + Projetos', 'Leonardo Moura', '2,7', '49.385', '239,90'));
courses.push(new Course('assets/img/courses/Curso-de-Javascript+Typescript+NodeJs-Programador-JS.jpg', 'Curso de Javascript + Typescript + NodeJs - Programador JS', 'Dener Troquatte', '2,9', '88', '79,90', 'Classificação mais alta'));
...
courses.push(new Course('assets/img/courses/Curso-React+Redux-Fundamentos-e-2-Apps-do-Absoluto-ZERO.jpg', 'Curso React + Redux: Fundamentos e 2 Apps do Absoluto ZERO!', 'Leonardo Moura', '3,8', '11.786', '179,90', 'Classificação mais alta'));
courses.push(new Course('assets/img/courses/Next.js-e-React-Curso-Completo-Aprenda-com-Projetos.jpg', 'Next.js e React - Curso Completo - Aprenda com Projetos', 'Leonardo Moura', '2,7', '1.885', '179,90'));
courses.push(new Course('assets/img/courses/Bancos-de-Dados-SQL-e-NoSQL-do-básico-ao-avançado.jpg', 'Bancos de Dados SQL e NoSQL do básico ao avançado', 'Geek University', '2,7', '2.811', '179,90', 'Classificação mais alta'));
courses.push(new Course('assets/img/courses/Bancos-de-dados-relacionais-SQL-do zero ao avançado.jpg', 'Bancos de dados relacionais - SQL (do zero ao avançado)', 'Cezar Augusto Crummenauer', '3,8', '52', '159,90'));
courses.push(new Course('assets/img/courses/Banco-de-Dados-Da-modelagem-à-SQL-com-PostgreSQL.jpg', 'Banco de Dados: Da modelagem à SQL com PostgreSQL', 'Tadeu Pereira', '2,9', '118', '94,90', 'Classificação mais alta'));
class Section {
